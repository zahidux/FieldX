...
const Region = () => {
  return (
    <>
      {/* page title */}
      <Helmet>
        <title>Dashboard Region</title>
      </Helmet>
      <section className="my-5 md:mx-5 rounded-md duration-300">
        <div className="flex items-center justify-between mb-5">
          <div>
            <h2 className="text-2xl text-dark font-semibold">Region List</h2>
            ...
            <div className="flex items-center gap-1 mt-1 text-sm">
              ...
              <Link to="/dashboard/region" className="text-blue">
                Geo List
              </Link>
            </div>
          </div>
